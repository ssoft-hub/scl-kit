...
| Type | Name |
| ---: | :--- |
|  ::std::string\_view | [**enum\_name**](#function-enum_name) () noexcept<br>_Retrieves the qualified string name of an enum member at compile-time._  |
|  ::std::string\_view | [**enum\_short\_name**](#function-enum_short_name) () noexcept<br>_Retrieves the short string name of an enum member at compile-time._  |
...
```
template<auto V>
::std::string_view enum_name () noexcept
```
...
```
template<auto V>
::std::string_view enum_short_name () noexcept
```
