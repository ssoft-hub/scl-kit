...
| Type | Name |
| ---: | :--- |
|  requires ::std::is\_enum\_v&lt; decltype(V)&gt;constexpr ::std::string\_view | [**enum\_name**](#function-enum_name) () <br>_Retrieves the qualified string name of an enum member at compile-time._  |
|  requires ::std::is\_enum\_v&lt; decltype(V)&gt;constexpr ::std::string\_view | [**enum\_short\_name**](#function-enum_short_name) () <br>_Retrieves the short string name of an enum member at compile-time._  |
|  ::std::string\_view | [**symbol\_name**](#function-symbol_name) () <br>_Retrieves the qualified string name of a symbol at compile-time._  |
|  ::std::string\_view | [**symbol\_short\_name**](#function-symbol_short_name) () <br>_Retrieves the short string name of a symbol at compile-time._  |
|  auto | [**type\_name**](#function-type_name) () <br>_Retrieves the string name of the template type T at compile-time._  |
|  auto | [**type\_short\_name**](#function-type_short_name) () <br>_Retrieves the short name of the template type T at compile-time._  |
...
```
template<auto V>
requires ::std::is_enum_v< decltype(V)>constexpr ::std::string_view enum_name () 
```
...
```
template<auto V>
requires ::std::is_enum_v< decltype(V)>constexpr ::std::string_view enum_short_name () 
```
...
```
template<auto S>
::std::string_view symbol_short_name () 
```
