...
# Struct ScL::Feature::Inplace::Debug::Holder

**template &lt;typename \_Value&gt;**



[**ClassList**](annotated.md) **>** [**ScL**](namespaceScL.md) **>** [**Feature**](namespaceScL_1_1Feature.md) **>** [**Inplace**](namespaceScL_1_1Feature_1_1Inplace.md) **>** [**Debug**](structScL_1_1Feature_1_1Inplace_1_1Debug.md) **>** [**Holder**](structScL_1_1Feature_1_1Inplace_1_1Debug_1_1Holder.md)
...
| Type | Name |
| ---: | :--- |
|  constexpr void | [**guard**](#function-guard) (\_HolderRefer &&) <br> |
|  constexpr void | [**unguard**](#function-unguard) (\_HolderRefer &&) <br> |
...
```C++
using ScL::Feature::Inplace::Debug::Holder< _Value >::ThisType =  Holder<_Value>;
```
...
```C++
using ScL::Feature::Inplace::Debug::Holder< _Value >::Value =  _Value;
```
...
```C++
Value ScL::Feature::Inplace::Debug::Holder< _Value >::m_value;
```
...
inline constexpr ScL::Feature::Inplace::Debug::Holder::Holder (
...
static inline constexpr void ScL::Feature::Inplace::Debug::Holder::guard (
    _HolderRefer &&
) 
```
...
```C++
template<typename _HolderRefer>
static inline constexpr void ScL::Feature::Inplace::Debug::Holder::unguard (
    _HolderRefer &&
) 
```
...
```C++
template<typename _HolderRefer>
static inline constexpr decltype(auto) ScL::Feature::Inplace::Debug::Holder::value (
    _HolderRefer && holder
) 
```
