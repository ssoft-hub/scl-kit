...
| Type | Name |
| ---: | :--- |
|  constexpr [**siphash\_key**](structscl_1_1hash_1_1siphash__key.md) | [**siphash\_default\_key**](#variable-siphash_default_key)   = `/* multi line expression */`<br>_Default key for non-security-sensitive use._  |
